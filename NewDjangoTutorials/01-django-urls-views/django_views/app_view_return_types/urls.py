...
urlpatterns = [
    ...
    # localhost:8000/app_view_return_types/plain_text/
    # localhost:8000/app_view_return_types/xml_text/
    # localhost:8000/app_view_return_types/json_response/
    # localhost:8000/app_view_return_types/html_response/
    # localhost:8000/app_view_return_types/streaming/
    # localhost:8000/app_view_return_types/file_response/
