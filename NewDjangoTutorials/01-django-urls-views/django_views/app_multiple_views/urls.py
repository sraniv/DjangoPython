...
urlpatterns = [
    # localhost:8000/app_multiple_views/hello/tinitiate
    # localhost:8000/app_multiple_views/bday/tinitiate
    path('hello/<str:in_data>', greetings.hello, name='hello'),
    path('bday/<str:in_data>', greetings.bday, name='bday'),

    # localhost:8000/app_multiple_views/num_square/3
    # localhost:8000/app_multiple_views/even_or_odd/1
